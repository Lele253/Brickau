  ...
  <div class="home">
    ...
    <div class="containerTwo desktop hidden-sm-and-down mt-10">
      <v-row class="d-flex justify-center" style="height: 50%; width: 100vw;">
        <v-col class="cardOne" cols="12" lg="4"
               md="12"
               sm="12"
               style="background-color: rgba(127,255,212,0.44)"
               xs="12"
        >
        ...
        <v-col class="cardTwo" cols="12" lg="4" md="12" sm="12"
               style="background-color: rgba(127,255,212,0.45)"
               xs="12"
        >
        ...
        <v-col class="cardThree" cols="12" lg="3" md="12" sm="12" style="background-color: rgba(127,255,212,0.44)"
               xs="12">
    ...
    <div class="containerTwo tablet hidden-md-and-up mt-10">
      <v-row style="height: 50%; width: 100vw;">
        ...
        <v-col class="card" cols="12" lg="4" md="12" sm="12" style="background-color: rgba(127,255,212,0.45)" xs="12">
          <h2 class="text-center mt-5"> Anmelden</h2>
          <p class="text-center mt-5 mx-10">
            Sie sind Student vom mir und möchten sich Dateien herunterladen? Dann melden Sie
            sich mit den von mir bereitgestellten Anmeldedaten an!
        ...
        <v-col class="card" cols="12" lg="3" md="12" sm="12"
               style="background-color: rgba(127,255,212,0.44)" xs="12">
      ...
      <v-row style="width: 100%;">
        ...
        <v-col cols="12" lg="6" md="6" sm="12">
          <div class="d-flex justify-center" style="width: 100%; max-height: 250px">
            <Icon class="mt-5 text-grey" icon="ic:baseline-anchor" style="font-size: 200px; margin-right: 40%"/>
          </div>

          <div class="d-flex justify-center text-white" style="width: 100%">
            <h1 id="about" style="margin-right: 40%">About Company</h1>
          </div>
    ...
    <div class="containerThree tablet hidden-md-and-up mt-3 ml-0" style="min-height: 800px; width: 100vw">
      <v-row class="pl-6" style="width: 100%;">
        ...
        <v-col cols="12" lg="6" md="6" sm="12">
          <div class="d-flex justify-center" style="width: 100%; max-height: 250px">
            <Icon class="mt-5 text-grey" icon="ic:baseline-anchor" style="font-size: 200px"/>
          </div>
